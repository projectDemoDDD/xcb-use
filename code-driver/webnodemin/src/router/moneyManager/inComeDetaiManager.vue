<template>
    <div class="inComeDetailManagerRoot">
        ...
        <van-popup v-model:show="inputBoxShow" position="bottom" :style="{ height: '40%' }">
            ...
            <van-field v-model="currentItem.money" label="入账" placeholder="请输入入账金额" />
...
.inComeDetailManagerRoot ul {
    width: 100vw;
}

.inComeDetailManagerRoot ul li {
    margin-top: 2vw;
    display: flex;
    justify-content: space-around;
}

.inComeDetailManagerRoot ul li button {
    flex: 1;
    background-color: red;
}


.inComeDetailManagerRoot ul li div {
    display: flex;
